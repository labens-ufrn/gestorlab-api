...
from __all_models import UsuarioLaboratorioAssociation, Usuario, LaboratorioProjetoAssociation, Projeto
...
class Laboratorio(SQLModel, table=True):
    ...
    projetos: List[Projeto] = Relationship(back_populates="laboratorios", secondary= LaboratorioProjetoAssociation)